...
// // Revised WithdrawForm Component
// function WithdrawForm(props) {
//   const [amount, setAmount] = React.useState('');
//   const [error, setError] = React.useState('');
//   const ctx = React.useContext(UserContext);
...
//       } catch (err) {
//         setStatus('Failed to fetch balance');
//         console.log('Error during balance fetch:', err.message);
//       }
//     }
...
//     } catch (err) {
//       setStatus('Failed to fetch balance');
//       console.log('Error during balance update:', err.message);
//     }
//   };
...
//       status={status}
//       body={show ? 
//         <WithdrawForm setShow={setShow} setStatus={setStatus} updateBalance={updateBalance} /> :
//         <WithdrawMsg setShow={setShow} setStatus={setStatus} />}
//     />
//   );
// }
